...
for (let number = 1; number <= 5; number++) {
  items.push(
    <Pagination.Item className='prom' key={number} active={number === active}>
      {number}
    </Pagination.Item>,
  );
}
...
function Works() {
  return (
    // <Layout>
    <section id="works" className="block works-block" style={{ marginTop: "120px"}}>
      <Container fluid>
        ...
        <Pagination className='progess'>{items}</Pagination>
      </Container>  
    </section>
    // </Layout>
  );
